...
export default function EditProductPage({ params }: { params: { id: string } }) {
    ...
    useEffect(() => {
        ...
        const product = dummyData.products.find(p => p.id === params.id);
        if (product) {
            setFormData({
                name: product.name,
                sku: product.sku,
            ...
            addNotification('error', 'Product not found');
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        // Simulate API call
        setTimeout(() => {
            addNotification('success', `Product "${formData.name}" updated successfully!`);
            router.push('/products');
        }, 1000);
    };
            ...
            <div className="bg-surface border border-border rounded-lg overflow-hidden">
                ...
                <div className="px-6 py-4 border-b border-border bg-background-secondary/20">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <h1 className="text-xl md:text-2xl font-bold text-primary">Edit Product</h1>
                            <p className="text-sm text-text-secondary">Update product details</p>
                        </div>
                    </div>
                </div>
